...
aria.Listbox = class Listbox {
    ...
    checkKeyPress(evt) {
        ...
        const currentItem = document.getElementById(this.activeDescendant) || allOptions[0];
    ...
    findNextOption(currentOption) {
        const allOptions = Array.prototype.slice.call(this.listboxNode.querySelectorAll('[role="option"]')); // get options array
    ...
    selectRange(start, end) {
        ...
        const endIndex = typeof end === 'number' ? end : this.getElementIndex(end, allOptions);
...
export function initListBox() {
    ...
    if (document.getElementById('ss_imp_list')) {
        ...
        ex1ImportantListbox.enableMoveUpDown(document.getElementById('ex1-up'), document.getElementById('ex1-down'));
...
//# sourceMappingURL=listbox_ranker.js.map